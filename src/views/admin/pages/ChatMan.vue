...
<template>
    <div class="flex h-[calc(100vh-8rem)] overflow-hidden rounded-2xl border border-surface-200 bg-surface-0 shadow-sm dark:border-surface-700 dark:bg-surface-900">
        <!-- ── Left: Conversation list ─────────────────────────────────── -->
        <div class="flex w-72 shrink-0 flex-col border-r border-surface-200 dark:border-surface-700 xl:w-80">
            <!-- Header -->
