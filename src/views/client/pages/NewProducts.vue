    ...
    <div class="bg-gray-50 dark:bg-zinc-900">
        <div class="container mx-auto px-4 py-10">
            <div class="mb-8 text-center">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Sản Phẩm Mới Về</h1>
                <p class="mt-2 text-lg text-gray-500">Khám phá những món đồ chơi hot nhất vừa cập bến</p>
            </div>
